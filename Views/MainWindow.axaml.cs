    ...
    private readonly List<(TokenType Type, string Pattern)> _definitions = new()
        {
            ...
            (TokenType.Keyword, @"\b(var|drucke|leeren|eingabe|lese_datei|importiere|ist|sonst|während|beenden|warte|zeichne|wenn)\b"), // Keywords vor Identifiern!
...
public class Parser
{
    ...
    private Statement ParseStatement()
    {
        ...
        if (Check(TokenType.Keyword) && Peek().Value == "beenden")
        {
